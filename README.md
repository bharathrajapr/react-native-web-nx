...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/ALNqvGG0wD)
...
```sh
npx nx serve react-native-web-app-new
```

To create a production bundle:

```sh
npx nx build react-native-web-app-new
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-native-web-app-new
```
